...
export const EMAIL_ALREADY_IN_USE = {
    reason: "The provided email is already in use",
    id: 3,
...
export const INSUFFICIENT_PERMISSIONS = {
    reason: "You don't have sufficient permissions to execute the following action",
    id: 7,
    code: "INSUFFICIENT PERMISSIONS",
}
export const INVALID_EMAIL_FORMAT = {
    reason: "The supplied email is not a valid email address",
    id: 8,
    code: "INVALID EMAIL FORMAT",
}
export const INVALID_PASSWORD_FORMAT = {
    reason: "Password must be at least 6  characters long, include an uppercase letter, a lowercase letter and a number",
    id: 9,
    code: "INVALID PASSWORD FORMAT",
}
export const INVALID_RECOVERY_CODE = {
    reason: "Provided recovery code is either invalid or expired",
    id: 10,
